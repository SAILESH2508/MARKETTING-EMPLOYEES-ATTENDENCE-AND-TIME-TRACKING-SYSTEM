...
DARK_MODE = {
    "bg": "#1A1A2E",        # Classic Dark Blue-Grey
    "fg": "#FFFFFF",        # White text
    "card": "#2E2E2E",      # Slightly lighter card
    "card_border": "#444444",
...
class RoundedFrame(tk.Canvas):
    ...
    """
    def __init__(self, parent, width=300, height=150, corner_radius=15, 
                 bg_color=None, border_color=None, **kwargs):
        super().__init__(parent, width=width, height=height, highlightthickness=0, **kwargs)
        
        self.corner_radius = corner_radius
        self.bg_color = bg_color if bg_color else theme['card']
        self.border_color = border_color if border_color else theme.get('card_border', self.bg_color)
        
        # This frame will hold the actual widgets
        self.inner_frame = tk.Frame(self, bg=self.bg_color)
        self.window_item = self.create_window((corner_radius, corner_radius), window=self.inner_frame, anchor='nw')
    ...
    def _draw_background(self, width, height):
        ...
        self.create_polygon(
            ...
            x0, y1, x0, y1-r,
            x0, y0+r, x0, y0,
            smooth=True, fill=self.bg_color, outline=self.border_color, width=1, tags="bg_rect"
        )
...
class ToolTip:
    ...
    def show(self, _=None):
        ...
        label = tk.Label(tw, text=self.text, justify='left', 
                         ...
                         relief='solid', borderwidth=0, font=("Segoe UI", 9))
...
class CustomButton(tk.Button):
    def __init__(self, parent, text, command, bg=None, fg=None, width=None, **kwargs):
        ...
        super().__init__(parent, text=text, font=BUTTON_FONT,
                         bg=bg, fg=fg,
    ...
    for widget in window.winfo_children():
        ...
        try:
            ...
            if widget_class in ('Frame', 'Toplevel'):
                ...
                style.configure('TNotebook.Tab', background=theme['card'], foreground=fg_color)
...
def apply_treeview_style(style):
    ...
    # Row Style: Card Background, White Text
    row_bg = theme.get("card", "#2E2E2E")
    row_fg = theme.get("fg", "#FFFFFF")
    ...
    style.map("Dark.Treeview", 
              background=[('selected', theme.get("button", "#E94560"))],
